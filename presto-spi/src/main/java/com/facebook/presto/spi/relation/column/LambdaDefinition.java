...
public final class LambdaDefinition<T>
        extends ColumnExpression<T>
{
    private final List<Type> argumentTypes;
    private final List<String> arguments;
    private final ColumnExpression<String> body;

    public LambdaDefinition(List<Type> argumentTypes, List<String> arguments, ColumnExpression body)
    {
    ...
    public ColumnExpression<String> getBody()
    {
        return body;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        LambdaDefinition that = (LambdaDefinition) o;
