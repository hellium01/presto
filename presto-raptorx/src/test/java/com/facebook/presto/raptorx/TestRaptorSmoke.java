        ...
        extends AbstractTestIntegrationSmokeTest
{
    ...
    {
        computeActual("CALL system.force_commit_cleanup()");
    }
    ...
    public void testTableConflict()
    {
        try (Transaction tx1 = new Transaction(); Transaction tx2 = new Transaction()) {
            ...
            tx2.update("CREATE TABLE tx_conflict (x bigint)");
    ...
    public void testRollbackRecovery()
    {
        ...
        computeActual("CALL system.force_recovery()");
    }
    ...
    {
        @Language("SQL") String from = "FROM system.chunks WHERE table_schema = 'tpch' AND table_name = 'sys_chunks'";
