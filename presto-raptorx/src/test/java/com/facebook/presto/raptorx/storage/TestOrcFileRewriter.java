...
public class TestOrcFileRewriter
{
            ...
            throws Exception
    {
        ...
        try (OrcFileWriter writer = new OrcFileWriter(chunkId, columnIds, columnTypes, file, TYPE_MANAGER, STATS)) {
        ...
        OrcFileInfo info = rewriteOrcFile(newChunkId, file, newFile, columns, rowsToDelete, READER_ATTRIBUTES, TYPE_MANAGER, STATS);
    ...
    public void testUncompressedSize()
    {
        ...
        long newChunkId = 91;
        File newFile = new File(temporary, randomUUID().toString());
        OrcFileInfo info = rewriteOrcFile(newChunkId, file, newFile, columns, new BitSet(), READER_ATTRIBUTES, TYPE_MANAGER, STATS);
        assertEquals(info.getRowCount(), 3);
        assertThat(info.getUncompressedSize()).isBetween(80L, 200L);
    }
}
