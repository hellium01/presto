...
public class PlanOptimizers
{
            ...
            TaskCountEstimator taskCountEstimator)
    {
        ...
        builder.add(new IndexJoinOptimizer(metadata), // Run this after projections and filters have been fully simplified and pushed down
                new IterativeOptimizer(
                        ruleStats,
                        statsCalculator,
                        estimatedExchangesCostCalculator,
        ...
        if (!forceSingleNode) {
            ...
            builder.add(new StatsRecordingPlanOptimizer(optimizerStats, new AddExchanges(metadata)));
        }
