...
import static com.facebook.presto.sql.planner.optimizations.AggregationNodeUtils.groupingSets;
    ...
    private AggregationNode map(AggregationNode node, PlanNode source, PlanNodeId newNodeId)
    {
        ...
        return new AggregationNode(
                ...
                groupingSets(
                        ...
                        node.getGroupingSets().getGroupingSetCount(),
                        node.getGroupingSets().getGlobalGroupingSets()),
                ImmutableList.of(),
                node.getStep(),
