        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Set<Symbol>>
    {
        ...
        {
            PlanNode source = context.rewrite(node.getSource(), ImmutableSet.copyOf(node.getRowIds()));
            return new DeleteNode(node.getId(), source, node.getTarget(), node.getRowIds(), node.getOutputSymbols());
        }
