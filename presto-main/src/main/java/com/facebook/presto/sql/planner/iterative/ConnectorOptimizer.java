        ...
        implements PlanOptimizer
{
    ...
    private boolean exploreNode(int group, Context context)
    {
        ...
        Optional<Relation> relation = context.relationTranslator.translate(node);
    ...
    private static class Context
    {
        ...
        private final RelationTranslator relationTranslator;
        ...
        public Context(
                ...
                Session session,
                RelationTranslator relationTranslator,
