...
import static com.facebook.presto.sql.planner.optimizations.AggregationNodeUtils.isStreamable;
        ...
        implements Rule<AggregationNode>
{
    ...
    private static boolean isSupportedAggregationNode(AggregationNode aggregationNode)
    {
        ...
        if (isStreamable(aggregationNode)) {
            return false;
        }
        ...
        return aggregationNode.getStep() == PARTIAL && aggregationNode.getGroupingSets().getGroupingSetCount() == 1;
    }
