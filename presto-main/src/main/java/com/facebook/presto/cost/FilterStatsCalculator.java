...
public class FilterStatsCalculator
{
            ...
            implements RowExpressionVisitor<PlanNodeStatsEstimate, Void>
    {
        ...
        {
            // comparison case
            if (StandardFunctionResolution.isComparisonFunction(node.getFunctionHandle())) {
                OperatorType operatorType = StandardFunctionResolution.getComparisonOperator(node);
