...
public class TestRowExpressionPredicateExtractor
{
    ...
    private final StandardExpressions standardExpressions = new StandardExpressions(metadata.getFunctionManager());
    ...
    {
        return standardExpressions.compare(OperatorType.EQUAL, expression1, expression2);
    }

    private RowExpression lessThan(RowExpression expression1, RowExpression expression2)
    {
        return standardExpressions.compare(OperatorType.LESS_THAN, expression1, expression2);
    }

    private RowExpression lessThanOrEqual(RowExpression expression1, RowExpression expression2)
    {
        return standardExpressions.compare(OperatorType.LESS_THAN_OR_EQUAL, expression1, expression2);
    }

    private RowExpression greaterThan(RowExpression expression1, RowExpression expression2)
    {
        return standardExpressions.compare(OperatorType.GREATER_THAN, expression1, expression2);
    }
